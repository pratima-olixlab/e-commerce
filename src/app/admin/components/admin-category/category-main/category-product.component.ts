...
import { CategoryDetails } from 'src/app/product';
...
export class CategoryProductComponent {
  constructor(private dialog: MatDialog,private store: AngularFirestore, private cartService: CartService){}
  ...
  newCategory(): void {
    ...
    dialogRef.afterClosed().subscribe((result: CategoryResult) => {
      ...
      const addedCategoryRef = this.store.collection('category').add(result.task);
